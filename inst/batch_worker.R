...
# WHAT CODE loads, load the CONSUMER package (meta$package / meta$dev_path) AND,
# when it differs, the RUNNER package (meta$runner_package -- "batchit"), then
# hand the whole envelope to <runner>:::.batch_execute() (resolve + hash-verify
# the target, re-validate args, run, write result). Runner and consumer are
